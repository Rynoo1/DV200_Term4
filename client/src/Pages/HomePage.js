...
function HomePage() {
    ...
    const [axiosCall, setAxiosCall] = useState('https://api.opendevweb-51212536012a.herokuapp.com/api/question_get_all/');
    ...
    useEffect(() => {
        ...
        // }
        if (axiosCall.startsWith('https://api.opendevweb-51212536012a.herokuapp.com/api/question_get_all/')) {
            Axios.get(axiosCall)
                .then(res => {
    ...
    const handleSearch = () => {
        if (searcher === '') {
            setAxiosCall('https://api.opendevweb-51212536012a.herokuapp.com/api/question_get_all/');
        } else {
            setAxiosCall('https://api.opendevweb-51212536012a.herokuapp.com/api/searchquestion/' + searcher);
        }
    }
    ...
    const handleLoadMore = () => {
        ...
        if (newLoaded >= totalEntries) {
            setloadMoreS(false);
            setAxiosCall(`https://api.opendevweb-51212536012a.herokuapp.com/api/question_get_all/?page=${nextpage}`);
        } else {
            setAxiosCall(`https://api.opendevweb-51212536012a.herokuapp.com/api/question_get_all/?page=${nextpage}`);
        }
    }
